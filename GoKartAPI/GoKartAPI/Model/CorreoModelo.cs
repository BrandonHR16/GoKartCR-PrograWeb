...
namespace GoKartAPI.Model
{
    public class CorreoModelo
    {
        ...
        public void enviarCorreo(Correo dataCorreo, IConfiguration configuracionP)
        {

            dataCorreo.Remitente = configuracionP.GetSection("Correo:Remitente").Value;
            var pasword = configuracionP.GetSection("Correo:Password").Value;
            //Crear un correo
            MailMessage correo = new MailMessage();
            //Configurar el correo
            correo.From = new MailAddress(dataCorreo.Remitente);
            correo.To.Add(dataCorreo.Destinatario);
            correo.Subject = dataCorreo.Asunto;
            correo.IsBodyHtml = true;
            correo.Body =  Mensaje(dataCorreo.Mensaje);
            ...
            smtp.Credentials = new System.Net.NetworkCredential(dataCorreo.Remitente, pasword);
            //Enviar el correo
            smtp.Send(correo);
        }
        ...
        public string Mensaje(string mensaje)
        {
            ...
            "         <tr style=\"border-collapse:collapse\"> " +
            "          <td align=\"center\" bgcolor=\"#f44316\" style=\"padding:0;Margin:0;background-color:#f44316\"> " +
            ...
            "         <tr style=\"border-collapse:collapse\"> " +
            "          <td style=\"padding:0;Margin:0;background-color:#f13a11\" bgcolor=\"#f13a11\" align=\"center\"> " +
            ...
            "                     <tr style=\"border-collapse:collapse\"> " +
            "                      <td align=\"center\" style=\"Margin:0;padding-left:10px;padding-right:10px;padding-top:25px;padding-bottom:25px;font-size:0px\"><img src=\"https://pejkrz.stripocdn.email/content/guids/CABINET_f0e455fe623235f86c2a9cc65d557c8d/images/my_project_1.png\" alt style=\"display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic\" height=\"175\"></td> " +
            "                     </tr> " +
            "                     <tr style=\"border-collapse:collapse\"> " +
            "                      <td class=\"es-m-txt-l\" align=\"left\" style=\"padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px\"><a target=\"_blank\" href=\"\" style=\"-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#131313;font-size:18px;word-break:break-all\">"+mensaje+"</a></td> " +
            "                     </tr> " +
            "                     <tr style=\"border-collapse:collapse\"> " +
            ...
            "                     <tr style=\"border-collapse:collapse\"> " +
            "                      <td align=\"center\" bgcolor=\"#f13a11\" style=\"padding:0;Margin:0;padding-top:30px;padding-left:30px;padding-right:30px\"><h3 style=\"Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#ffffff\">GoKartCr</h3></td> " +
            "                     </tr> " +
            "                     <tr style=\"border-collapse:collapse\"> " +
            "                      <td esdev-links-color=\"#ffa73b\" align=\"center\" bgcolor=\"#f13a11\" style=\"padding:0;Margin:0;padding-bottom:30px;padding-left:30px;padding-right:30px\"><br></td> " +
            "                     </tr> " +
            "                   </table></td> " +
            "                 </tr> " +
            "               </table></td> " +
        ...
        public CorreoRespuesta armarRespuesta(int idCodigo, string mensaje)
        {

            CorreoRespuesta respuesta = new CorreoRespuesta();
