...
namespace GoKartAPI.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("generarTokenRecuperacion")]
        public ActionResult<UsuarioRespuesta> generarTokenRecuperacionContrasennia(string correoUsuario)
        {
            ...
            try
            {
                ...
                if (usuario != null)
                {
                    ...
                    usuarioModel.generarTokenRecuperacionContrasennia(configuracion,correoUsuario);

                    eventoModel.registrarEvento("Usuario", "Se ha generado el token para el usuario: \n\n" +
                        "Nombre: " + usuario.primerNombre + " " + usuario.primerApellido + " " + usuario.segundoApellido +
                        "\n Correo: " + usuario.correoElectronico +
                        "\n Cédula: " + usuario.cedulaUsuario,
                        configuracion);
                    ...
                    return usuarioModel.armarRespuesta(0, "Token generado.", listaUsuarios);
                ...
                else
                {
                    ...
                    return usuarioModel.
                        armarRespuesta(1, "No se ha encontrado el usuario para general el token de recuperaion.",
                        new List<Usuario>());
        ...
        [HttpPut]
        [Route("restablecerContrasennia")]
        public ActionResult<UsuarioRespuesta> restablecerContrasennia(string correoUsuario, string tokenRecuperacion, string nuevaContrasennia)
        {
            ...
            try
            {
                ...
                if (usuario != null)
                {
                    ...
                    usuarioModel.restablecerContrasennia(configuracion, correoUsuario, tokenRecuperacion, nuevaContrasennia);

                    eventoModel.registrarEvento("Usuario", "Se ha restablecido la contraseña para el usuario: \n\n" +
                        "Nombre: " + usuario.primerNombre + " " + usuario.primerApellido + " " + usuario.segundoApellido +
                        "\n Correo: " + usuario.correoElectronico +
                        "\n Cédula: " + usuario.cedulaUsuario,
                        configuracion);
                    ...
                    return usuarioModel.armarRespuesta(0, "Contraseña actualizada.", listaUsuarios);
                ...
                else
                {
                    ...
                    return usuarioModel.
                        armarRespuesta(1, "No se ha encontrado el usuario para restablecer la contraseña.",
                        new List<Usuario>());
